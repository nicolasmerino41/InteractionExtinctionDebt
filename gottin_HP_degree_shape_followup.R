...
## ------------------------------------------------------------
## Script: gottin_HP_degree_shape_followup.R
## ------------------------------------------------------------

dataset_label <- "Gottin_HP"
p_fixed <- 0.074
previous_degree_dir <- "Gottin/degree_site_removal_HP"
out_dir <- "Gottin/degree_shape_followup_HP"
...
load_dataset_webs <- function(){
  ...
  webs <- frame2webs(raw_data, varnames = c("Genus.Species", "P1.Species.Genus", "Site", "P1.cells"))
