...
vazag = t(read.csv("Nahuel/raw-data/vaz_ag_matr_f.txt", sep="\t", header=FALSE))
vazcl = t(read.csv("Nahuel/raw-data/vaz_cl_matr_f.txt", sep="\t", header=FALSE))
vazll = t(read.csv("Nahuel/raw-data/vaz_ll_matr_f.txt", sep="\t", header=FALSE))
vazmh = t(read.csv("Nahuel/raw-data/vaz_mh_matr_f.txt", sep="\t", header=FALSE))
vazmnh = t(read.csv("Nahuel/raw-data/vaz_mnh_matr_f.txt", sep="\t", header=FALSE))
vazqh = t(read.csv("Nahuel/raw-data/vaz_qh_matr_f.txt", sep="\t", header=FALSE))
vazqnh = t(read.csv("Nahuel/raw-data/vaz_qnh_matr_f.txt", sep="\t", header=FALSE))
vazs = t(read.csv("Nahuel/raw-data/vaz_s_matr_f.txt", sep="\t", header=FALSE))
...
write.csv(realisations_indegree, file = 'random_realisations_expected_indegree_nahuel.csv')
write.csv(realisations_outdegree, file = 'random_realisations_expected_outdegree_nahuel.csv')
...
write.csv(expected_realised_indegree_freq, file = 'expected_realised_indegree_nahuel.csv')
...
write.csv(expected_realised_outdegree_freq, file = 'expected_realised_outdegree_nahuel.csv')
...
write.csv(occupancy_pred, file = 'occupancy_pred_nahuel.csv')
write.csv(occupancy_prey, file = 'occupancy_prey_nahuel.csv')
...
write.csv(network_real_pred, file = 'network_real_pred_nahuel.csv')
write.csv(network_real_prey, file = 'network_real_prey_nahuel.csv')
write.csv(network_coocurrence_pred, file = 'network_coocurrence_pred_nahuel.csv')
write.csv(network_coocurrence_prey, file = 'network_coocurrence_prey_nahuel.csv')
...
p <- 0.16 # p here is the percentage of interactions that where realised from the co-occurrence network to the network of biotic interactions
...
write.csv(realisations_indegree_null_model, file = 'null_random_realisations_expected_indegree_nahuel.csv')
write.csv(realisations_outdegree_null_model, file = 'null_random_realisations_expected_outdegree_nahuel.csv')
